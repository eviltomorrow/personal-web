      ...
      <div className="flex flex-1 flex-col overflow-hidden relative">
        ...
        <header className="relative flex h-14 flex-shrink-0 items-center justify-between border-b border-[#e8e8ed]/70 bg-white/80 px-6 backdrop-blur-xl z-10">
          <div className="flex items-center gap-2 text-[13px] text-[#86868b]">
            <span className="text-[#d2d2d7]">/</span>
            <span className="font-medium text-[#1d1d1f]">首页</span>
          </div>

          <div className="flex items-center gap-2">
            <button className="hidden sm:flex items-center gap-2 rounded-lg bg-[#f5f5f7] px-3 py-1.5 text-[13px] text-[#86868b] transition-all duration-200 hover:bg-[#e8e8ed] focus:outline-none focus:ring-2 focus:ring-[#0071e3]/20">
              {I.Search}
              <span>搜索...</span>
              <span className="ml-2 rounded border border-[#d2d2d7]/50 px-1.5 py-0.5 text-[10px] font-medium text-[#d2d2d7]">⌘K</span>
            </button>

            <button className="relative flex h-8 w-8 items-center justify-center rounded-full text-[#86868b] transition-all duration-200 hover:bg-[#f5f5f7] hover:text-[#6e6e73]">
              {I.Bell}
              <span className="absolute right-2 top-1.5 h-2 w-2 rounded-full bg-[#ff3b30] ring-2 ring-white" />
            </button>

            <button className="flex items-center gap-2 rounded-full pl-1 pr-2 py-0.5 transition-all duration-200 hover:bg-[#f5f5f7]">
              <div className="h-7 w-7 overflow-hidden rounded-full bg-gradient-to-br from-[#0071e3] to-[#005bbf] ring-2 ring-white shadow-sm">
                {avatarUrl ? (
                  <img src={avatarUrl} alt="" className="h-full w-full object-cover" />
                ) : (
                  <div className="flex h-full w-full items-center justify-center text-[11px] font-medium text-white">{initial}</div>
                )}
              </div>
              <span className="hidden sm:inline text-[12px] font-medium text-[#1d1d1f]">{nickname}</span>
            </button>
          </div>
        </header>
