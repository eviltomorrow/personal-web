  ...
  return (
    <div className="min-h-screen bg-[#f5f5f7]">
      ...
      <header className="sticky top-0 z-50 border-b border-[#d2d2d7]/60 bg-white/80 backdrop-blur-xl">
        <div className="mx-auto flex h-14 max-w-[980px] items-center justify-between px-6">
          <span className="text-[15px] font-semibold text-[#1d1d1f]">liarsa</span>
          <div className="flex items-center gap-4">
            <span className="text-[13px] text-[#6e6e73]">shepard@example.com</span>
            <div className="h-8 w-8 rounded-full bg-[#0071e3] flex items-center justify-center text-[13px] font-medium text-white">
              S
            </div>
          </div>
        </div>
      ...
      <main className="mx-auto max-w-[980px] px-6 pt-10 pb-20">
        <div className="mb-10">
          ...
          <div className="rounded-2xl border border-[#d2d2d7] bg-white p-6">
            ...
            <div className="mt-4 grid grid-cols-2 gap-3">
              {["写文章", "新建项目", "查看统计", "系统设置"].map((label) => (
                <button
                  key={label}
                  className="rounded-xl border border-[#d2d2d7] bg-[#f5f5f7] px-4 py-3 text-[13px] font-medium text-[#1d1d1f] transition-all duration-200 hover:border-[#0071e3] hover:text-[#0071e3]"
                >
                  {label}
                </button>
              ))}
